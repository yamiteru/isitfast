...
export const compileStartupNode = () => compileFiles("startup", async ({
  ...
  const content = `
    ...
    ${TEMPLATE_BUFFER}.writeUInt8(parseInt(${TEMPLATE_PERFORMANCE_TIMING}.duration * ${NS_IN_MS}), ${BUFFER_DURATION_INDEX});
    ${TEMPLATE_BUFFER}.writeUInt8(parseInt(${TEMPLATE_PERFORMANCE_TIMING}.nodeStart * ${NS_IN_MS}), ${BUFFER_NODE_INDEX});
    ${TEMPLATE_BUFFER}.writeUInt8(parseInt(${TEMPLATE_PERFORMANCE_TIMING}.v8Start * ${NS_IN_MS}), ${BUFFER_V8_INDEX});
    ${TEMPLATE_BUFFER}.writeUInt8(parseInt(${TEMPLATE_PERFORMANCE_TIMING}.bootstrapComplete * ${NS_IN_MS}), ${BUFFER_BOOTSTRAP_INDEX});
    ${TEMPLATE_BUFFER}.writeUInt8(parseInt(${TEMPLATE_PERFORMANCE_TIMING}.environment * ${NS_IN_MS}), ${BUFFER_ENVIRONMENT_INDEX});
    ${TEMPLATE_BUFFER}.writeUInt8(parseInt(${TEMPLATE_PERFORMANCE_TIMING}.loopStart * ${NS_IN_MS}), ${BUFFER_LOOP_INDEX});
