...
export interface SuiteInterface<$Data, $Benchmarks extends string[] = []> {
  setup: <$$Data extends $Data>(
    fn: Fn<[], $$Data>,
  ) => SuiteInterface<$$Data, $Benchmarks>;

  add: <$Name extends string>(
    name: $Name,
    benchmark: Benchmark<$Data>,
    events?: Events,
  ) => SuiteInterface<$Data, [...$Benchmarks, $Name]>;

  onSuiteStart: Fn<[Fn<[], Promise<void>>], SuiteInterface<$Data, $Benchmarks>>;

  onSuiteEnd: Fn<[Fn<[], Promise<void>>], SuiteInterface<$Data, $Benchmarks>>;
...
export type SuiteAny = SuiteInterface<any, any>;

export type SuiteInferData<$Suite extends SuiteAny> = $Suite extends SuiteInterface<
  infer $Data,
  any
>
  ? $Data
...
export type SuiteInferBenchmarks<$Suite extends SuiteAny> =
  $Suite extends SuiteInterface<any, infer $Benchmarks> ? $Benchmarks : never;
